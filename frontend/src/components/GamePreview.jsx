...
<body>
  ...
  <script>IlmuEducatorQuiz.init(${configJson});<\/script>
</body>
</html>`;
}
...
function buildMemoryHTML(engineConfig) {
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>' +
    ...
    '/engines/memory-engine.js"></script><script>IlmuEducatorMemory.init(' + configJson +
    ');</script></body></html>';
}
function buildTermSprintHTML(engineConfig) {
  ...
  return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>' +
    ...
    '</title><style>' + GAME_STYLES +
    '</style></head><body><div id="matching-app"></div><script src="' + window.location.origin +
    '/engines/term-sprint-engine.js"></script><script>IlmuEducatorTermSprint.init(' + configJson +
    ');</script></body></html>';
}
...
<body>
  ...
  <script>IlmuEducatorMatching.init(${configJson});<\/script>
</body>
</html>`;
}
