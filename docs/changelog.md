...
- Official-source country packs for every IlmuEducator region, plus a public curriculum-coverage endpoint and framework-only fallback links.

## 2026-07-19

### Added

- Local-first Teach Mode: run a lesson, track objectives, and save teacher reflection only on the current device.
